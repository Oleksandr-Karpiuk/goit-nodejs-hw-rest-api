...
const register = async (req, res) => {
  ...
  const verifyEmail = {
    ...
    html: `<a href="${BASE_URL}/api/auth/verify/${verificationToken}" target="_blank">Please, verify your email</a>`,
  };
...
const resendVerifyEmail = async (req, res) => {
  ...
  const verifyEmail = {
    to: email,
    subject: "Verify email",
    html: `<a href="${BASE_URL}/api/auth/verify/${user.verificationToken}" target="_blank">Please, verify your email</a>`,
  };
